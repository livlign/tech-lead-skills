---
name: dev-agent
description: Orchestrator for taking a backend (or full-stack) task through grooming → requirements → architecture → task plan → tech spec → tests → implementation → e2e → patch, with light reviewer gates between AI phases.
---
