...
> Investigation template for any reported defect. Load whenever a defect symptom is being diagnosed — fresh Bug Fix task, mid-Phase-7 finding, or Phase 8 E2E regression. Forces a verified call chain before any fix is proposed.
